...
#               $month_object = buy_aps( $month_object );
                $month_object->{total_to_invest} = $start_config->{monthly_investment} + ( $month_object->{num_aps} * ( $start_config->{monthly_rent} - $monthly_taxes - $monthly_reparations));
...
my $month  = {
        ...
        total_to_invest          => $start_config->{monthly_investment} + $start_config->{start_aparments_no} * $start_config->{monthly_rent},
